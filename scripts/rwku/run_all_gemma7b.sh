...
echo "[rwku][gemma-7b] Running GA"
bash "${script_dir}/ga_rwku.sh"

echo "[rwku][gemma-7b] Running AdaPop"
bash "${script_dir}/ada_pop_rwku.sh"

echo "[rwku][gemma-7b] Running GD"
bash "${script_dir}/gd_rwku.sh"

echo "[rwku][gemma-7b] Running WGA"
bash "${script_dir}/wga_rwku.sh"

echo "[rwku][gemma-7b] Running NPO"
