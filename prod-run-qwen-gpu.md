# Production Qwen GPU Runs

This runbook runs the 19 requested methods on Qwen, one method at a time.
...
Qwen is wired with separate DUET and RWKU model variables. The defaults below
currently point both phases to `Qwen2.5-7B-Instruct`; override the
`QWEN_DUET_*` or `QWEN_RWKU_*` variables if the GPU box has different Qwen
snapshots for DUET and RWKU.
...
export OUTPUT_ROOT=/data/home/vkropoti/unlearning/saves/unlearn-qwen
...
export QWEN_DUET_BASE_MODEL=${QWEN_DUET_BASE_MODEL:-Qwen2.5-7B-Instruct}
export QWEN_DUET_MODEL_CONFIG=${QWEN_DUET_MODEL_CONFIG:-Qwen2.5-7B-Instruct-lora}
export QWEN_DUET_MODEL_CFG=${QWEN_DUET_MODEL_CFG:-configs/model/Qwen2.5-7B-Instruct.yaml}
export QWEN_DUET_LORA_MODEL_CFG=${QWEN_DUET_LORA_MODEL_CFG:-configs/model/Qwen2.5-7B-Instruct-lora.yaml}
export QWEN_DUET_BASE_PATH=${QWEN_DUET_BASE_PATH:-/data/home/vkropoti/unlearning/models/BASE/Qwen2.5-7B-Instruct}
export QWEN_DUET_SFT_BASE=${QWEN_DUET_SFT_BASE:-/data/home/vkropoti/unlearning/SwetieePawsss/DUET_ft_models}
export QWEN_DUET_SFT_SUBFOLDER=${QWEN_DUET_SFT_SUBFOLDER:-qwen2.5-7b-instruct-tripunlamb-ft}

export QWEN_RWKU_BASE_MODEL=${QWEN_RWKU_BASE_MODEL:-Qwen2.5-7B-Instruct}
export QWEN_RWKU_MODEL_CONFIG=${QWEN_RWKU_MODEL_CONFIG:-Qwen2.5-7B-Instruct-lora}
export QWEN_RWKU_MODEL_CFG=${QWEN_RWKU_MODEL_CFG:-configs/model/Qwen2.5-7B-Instruct.yaml}
export QWEN_RWKU_LORA_MODEL_CFG=${QWEN_RWKU_LORA_MODEL_CFG:-configs/model/Qwen2.5-7B-Instruct-lora.yaml}
export QWEN_RWKU_BASE_PATH=${QWEN_RWKU_BASE_PATH:-/data/home/vkropoti/unlearning/models/BASE/Qwen2.5-7B-Instruct}
...
set_qwen_duet_model() {
  export BASE_MODEL="${QWEN_DUET_BASE_MODEL}"
  export MODEL_CONFIG="${QWEN_DUET_MODEL_CONFIG}"
  export MODEL_CFG="${QWEN_DUET_MODEL_CFG}"
  export LORA_MODEL_CFG="${QWEN_DUET_LORA_MODEL_CFG}"
  export HF_BASE_MODEL_PATH="${QWEN_DUET_BASE_PATH}"
  export BASE_MODEL_PATH="${HF_BASE_MODEL_PATH}"
  export BASE_MODEL_EVAL_CONFIG="${BASE_MODEL}"
  export LORA_MODEL_EVAL_CONFIG="${MODEL_CONFIG}"
  export DUET_LOCAL_SFT_BASE="${QWEN_DUET_SFT_BASE}"
  export DUET_SFT_SUBFOLDER="${QWEN_DUET_SFT_SUBFOLDER}"
}

set_qwen_rwku_model() {
  export BASE_MODEL="${QWEN_RWKU_BASE_MODEL}"
  export MODEL_CONFIG="${QWEN_RWKU_MODEL_CONFIG}"
  export MODEL_CFG="${QWEN_RWKU_MODEL_CFG}"
  export LORA_MODEL_CFG="${QWEN_RWKU_LORA_MODEL_CFG}"
  export HF_BASE_MODEL_PATH="${QWEN_RWKU_BASE_PATH}"
  export BASE_MODEL_PATH="${HF_BASE_MODEL_PATH}"
  export BASE_MODEL_EVAL_CONFIG="${BASE_MODEL}"
  export LORA_MODEL_EVAL_CONFIG="${MODEL_CONFIG}"
}
...
run_qwen_method() {
  run_qwen_duet_method
  run_qwen_rwku_method
}
...
DualCF variant and AdaPop in the Qwen output tree.
...
AdaPop is artifact-free. It uses the same Qwen `OUTPUT_ROOT` as the other
methods: `/data/home/vkropoti/unlearning/saves/unlearn-qwen`.
...
Run these after all Qwen jobs finish. Use the Qwen output root directly; do not
use `${OUTPUT_ROOT%/unlearn}` because this runbook saves into `unlearn-qwen`,
...
bash package_saves.sh \
  --path_to_saves "${OUTPUT_ROOT}" \
  --out_path /data/home/vkropoti/unlearning/saves-clean-qwen \
  --save_eval 0
```
