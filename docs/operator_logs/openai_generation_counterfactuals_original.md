...
# Original counterfactual generation operator notes

This file preserves the original machine-specific notes. Use
`docs/counterfactual_generation_api.md` for public reproduction guidance.
